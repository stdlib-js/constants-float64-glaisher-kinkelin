...
```javascript
A = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-glaisher-kinkelin@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var A = require( 'path/to/vendor/umd/constants-float64-glaisher-kinkelin/index.js' )
```
